...
private:
    ...
    MatrixXd state_forget_gate_weights;    //the weights of forget gate(for state cell) (C+1 * 1)
    MatrixXd hidden_forget_gate_weights;    //the weights of forget gate(for hidden cell) (H+1 * 1)
    MatrixXd input_forget_gate_weights;    //the weights of forget gate(for input cell) (I+1 * 1)
    ...
    MatrixXd forget_gate_act;    //the values of forget gate activation for time 1...T (1 * T)
    ...
    MatrixXd error_forget_gate;    //the error of forget gate (1 * T)
